...
public final class JsRpcMapStringInt extends JavaScriptObject {
    ...
    public native boolean forEachEntry(JsRpcStringIntProcedure procedure) /*-{
        for (x in this) { 
            if (this.hasOwnProperty(x)) {
                if (!procedure.@com.dotspots.rpcplus.client.jscollections.JsRpcStringIntProcedure::execute(Ljava/lang/String;I)(x.slice(1), this[x])) return false;
            }
        }
        return true;
    }-*/;
