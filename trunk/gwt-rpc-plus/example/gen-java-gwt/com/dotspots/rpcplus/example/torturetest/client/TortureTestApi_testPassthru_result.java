...
public final class TortureTestApi_testPassthru_result extends com.dotspots.rpcplus.client.jsonrpc.BaseJsRpcObject {
    // GWT requires a protected constructor
    protected TortureTestApi_testPassthru_result() {
    }

    /* Factory method */
    public static TortureTestApi_testPassthru_result create() {
        return com.google.gwt.core.client.JavaScriptObject.createArray().cast();
    }

    /* Factory method, strongly dependent on order of fields */
    public static native TortureTestApi_testPassthru_result create(String success) /*-{
        return [success];
    }-*/;
