...
public class FlexibleRemoteServiceServlet extends HttpServlet implements SerializationPolicyProvider {
	 ...
	 */
	public FlexibleRemoteServiceServlet() {
	}

	/**
	 * Standard HttpServlet method: handle the POST.
	 * 
	 * This doPost method swallows ALL exceptions, logs them in the ServletContext, and returns a GENERIC_FAILURE_MSG
	 ...
	 * <code>null</code> if it could not be determined. This information is encoded in the {@value #STRONG_NAME_HEADER}
	 * HTTP header.
	 */
	...
	/**
	 * Gets the <code>HttpServletRequest</code> object for the current call. It is stored thread-locally so that
	...
	/**
	 * Gets the <code>HttpServletResponse</code> object for the current call. It is stored thread-locally so that
	 * simultaneous invocations can have different response objects.
	 */
	...
	/**
	 * Override this method to examine the deserialized version of the request before the call to the servlet method is
	 * made. The default implementation does nothing and need not be called by subclasses.
	 */
	protected void onAfterRequestDeserialized(RPCRequest rpcRequest) {
	}

	/**
	 * Override this method to examine the serialized response that will be returned to the client. The default
	...
	/**
	 * Override this method to examine the serialized version of the request payload before it is deserialized into
	 * objects. The default implementation does nothing and need not be called by subclasses.
	 */
	...
	/**
	 * Determines whether the response to a given servlet request should or should not be GZIP compressed. This method
	 * is only called in cases where the requester accepts GZIP encoding.
	 * <p>
	 * This implementation currently returns <code>true</code> if the response string's estimated byte length is longer
	 * than 256 bytes. Subclasses can override this logic.
	 * </p>
	 * 
	 * @param request
	...
	/**
	 * Initializes the perThreadRequest and perThreadResponse fields if they are null. This will occur the first time
	 * they are accessed after an instance of this class is constructed or deserialized. This method should be called
	 * from within a 'synchronized(this) {}' block in order to ensure that only one thread creates the objects.
	 */
