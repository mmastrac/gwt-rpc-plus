...
// returning void because we ignore this production.
  ...
  final public SimpleNode Enum() throws ParseException {
   ...
   boolean jjtc000 = true;
   jjtree.openNodeScope(jjtn000);this.field_val = 0;
    try {
  ...
  final public DynamicSerDeFieldList Throws() throws ParseException {
   ...
   boolean jjtc000 = true;
   jjtree.openNodeScope(jjtn000);DynamicSerDeFieldList exceptions;
    try {
      if (jj_2_50(2)) {
...
{if (true) return jjtn000;}
  ...
  private boolean jj_3_68() {
    if (jj_scan_token(tok_void)) return true;
    return false;
  }
  ...
  private boolean jj_3R_17() {
    if (jj_scan_token(tok_typedef)) return true;
  ...
  private boolean jj_3R_15() {
    if (jj_scan_token(tok_service)) return true;
  ...
  private boolean jj_3R_37() {
    if (jj_scan_token(tok_list)) return true;
  ...
  private boolean jj_3R_21() {
    if (jj_scan_token(tok_exception)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3R_36() {
    if (jj_scan_token(tok_set)) return true;
    if (jj_scan_token(70)) return true;
    return false;
  }
  ...
  private boolean jj_3R_20() {
    if (jj_scan_token(tok_struct)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3R_35() {
    if (jj_scan_token(tok_map)) return true;
    if (jj_scan_token(70)) return true;
    return false;
  }
  ...
  private boolean jj_3R_30() {
    if (jj_scan_token(tok_bool)) return true;
    return false;
  }
  ...
  private boolean jj_3_56() {
    if (jj_scan_token(tok_skip)) return true;
    return false;
  }

  private boolean jj_3R_39() {
    if (jj_scan_token(tok_binary)) return true;
    return false;
  }

  private boolean jj_3_55() {
    if (jj_scan_token(tok_optional)) return true;
    return false;
  }
  ...
  private boolean jj_3_54() {
    if (jj_scan_token(tok_required)) return true;
    return false;
  }

  private boolean jj_3R_34() {
    if (jj_scan_token(tok_double)) return true;
    return false;
  }
  ...
  private boolean jj_3R_12() {
    if (jj_scan_token(tok_include)) return true;
    if (jj_scan_token(tok_literal)) return true;
    return false;
  }

  private boolean jj_3R_33() {
    if (jj_scan_token(tok_i64)) return true;
    return false;
  }
  ...
  private boolean jj_3R_32() {
    if (jj_scan_token(tok_i32)) return true;
    return false;
  }
  ...
  private boolean jj_3_18() {
    if (jj_scan_token(tok_csharp_namespace)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3R_31() {
    if (jj_scan_token(tok_i16)) return true;
    return false;
  }

  private boolean jj_3_36() {
    if (jj_scan_token(tok_double_constant)) return true;
    return false;
  }

  private boolean jj_3_17() {
    if (jj_scan_token(tok_xsd_namespace)) return true;
    if (jj_scan_token(tok_literal)) return true;
    return false;
  }
  ...
  private boolean jj_3_35() {
    if (jj_scan_token(tok_int_constant)) return true;
    return false;
  }
  ...
  private boolean jj_3_16() {
    if (jj_scan_token(tok_cocoa_prefix)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3R_14() {
    if (jj_scan_token(tok_const)) return true;
    if (jj_3R_38()) return true;
    return false;
  }

  private boolean jj_3_15() {
    if (jj_scan_token(tok_java_package)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3_14() {
    if (jj_scan_token(tok_smalltalk_prefix)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }

  private boolean jj_3R_29() {
    if (jj_scan_token(tok_string)) return true;
    return false;
  }
  ...
  private boolean jj_3_13() {
    if (jj_scan_token(tok_smalltalk_category)) return true;
    if (jj_scan_token(tok_st_identifier)) return true;
    return false;
  }

  private boolean jj_3_12() {
    if (jj_scan_token(tok_ruby_namespace)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3_11() {
    if (jj_scan_token(tok_perl_package)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }

  private boolean jj_3_50() {
    if (jj_scan_token(tok_throws)) return true;
  ...
  private boolean jj_3R_19() {
    if (jj_scan_token(tok_senum)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }

  private boolean jj_3_10() {
    if (jj_scan_token(tok_py_module)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3_49() {
    if (jj_scan_token(tok_async)) return true;
    return false;
  }

  private boolean jj_3_9() {
    if (jj_scan_token(tok_php_namespace)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3_8() {
    if (jj_scan_token(tok_cpp_include)) return true;
    if (jj_scan_token(tok_literal)) return true;
    return false;
  }
  ...
  private boolean jj_3_7() {
    if (jj_scan_token(tok_cpp_namespace)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3_6() {
    if (jj_scan_token(tok_namespace)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3R_18() {
    if (jj_scan_token(tok_enum)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3_47() {
    if (jj_scan_token(tok_extends)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    return false;
  }
