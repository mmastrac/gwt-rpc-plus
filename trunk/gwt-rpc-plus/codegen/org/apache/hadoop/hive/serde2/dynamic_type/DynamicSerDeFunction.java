...
public class DynamicSerDeFunction extends DynamicSerDeStructBase {
	...
	protected DynamicSerDeFunctionType type;
	protected DynamicSerDeFieldList exceptions;
	...
	public String toString() {
		String result = "function " + this.type + " " + this.name + " (";
		result += this.getFieldList().toString();
		result += ")";
		if (exceptions != null) {
			result += " " + exceptions.toString();
		}
		return result;
	}
	...
	public DynamicSerDeFieldList getExceptions() {
		return exceptions;
	}

	public DynamicSerDeFunctionType getReturnType() {
		return type;
	}
