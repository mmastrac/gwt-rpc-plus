...
public class SimpleObjectWithNoFieldIds implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("SimpleObjectWithNoFieldIds");
  ...
  static {
    FieldMetaData.addStructMetaDataMap(SimpleObjectWithNoFieldIds.class, metaDataMap);
  }

  public SimpleObjectWithNoFieldIds() {
  }
   ...
   */
  public SimpleObjectWithNoFieldIds(SimpleObjectWithNoFieldIds other) {
    if (other.isSetToken()) {
  ...
  @Override
  public SimpleObjectWithNoFieldIds clone() {
    return new SimpleObjectWithNoFieldIds(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SimpleObjectWithNoFieldIds)
      return this.equals((SimpleObjectWithNoFieldIds)that);
    return false;
  }

  public boolean equals(SimpleObjectWithNoFieldIds that) {
    if (that == null)
      return false;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SimpleObjectWithNoFieldIds(");
    boolean first = true;
